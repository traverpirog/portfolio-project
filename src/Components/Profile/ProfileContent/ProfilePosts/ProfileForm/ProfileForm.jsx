...
let ProfileForm = (props) => {
    ...
    return (
        <div className={classes.body}>
            <textarea ref={newPost} className={classes.textarea} placeholder='Введите текст...' onChange={onPostChange}  value={props.newPostText}/>
            <button className={classes.submit} onClick={addPost}>
